...
export default css`
  ...
  :host {
    ...
    --np-core-border-radius-l: 0.8em;
    --np-core-border-radius-xl: 1.6em;
  }
  ...
  :host {
    ...
    --np-core-font-size-l: 1.5em;
    --np-core-font-size-xl: 3em;

    --np-core-font-weight-xs: 100;
    --np-core-font-weight-s: 300;
    --np-core-font-weight-m: 500;
    --np-core-font-weight-l: 700;
    --np-core-font-weight-xl: 900;
  }
