...
export const shieldCheck = svg`<svg
  xmlns="http://www.w3.org/2000/svg"
  fill="none"
  viewBox="0 0 24 24"
  stroke-width="1.5"
...
export const shieldExclamation = svg`<svg
  xmlns="http://www.w3.org/2000/svg"
  fill="none"
  viewBox="0 0 24 24"
  stroke-width="1.5"
  stroke="currentColor"
  class="icon icon--shield-exclamation"
>
  <path
    stroke-linecap="round"
    stroke-linejoin="round"
...
export const lockOpen = svg`<svg
  xmlns="http://www.w3.org/2000/svg"
  fill="none"
  viewBox="0 0 24 24"
  stroke-width="1.5"
  stroke="currentColor"
  class="icon icon--lock-open"
>
  <path
    stroke-linecap="round"
    stroke-linejoin="round"
...
export const lockClosed = svg`<svg
  xmlns="http://www.w3.org/2000/svg"
  fill="none"
  viewBox="0 0 24 24"
  stroke-width="1.5"
